  ...
  return (
    <div className="min-h-screen relative bg-gradient-to-br from-white via-gray-50 to-white flex items-center justify-center p-6 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        {/* Green glow effects */}
        <div className="absolute top-20 right-20 size-96 bg-[#2DCE73]/10 rounded-full blur-3xl" />
        <div className="absolute bottom-20 left-20 size-80 bg-[#013B34]/5 rounded-full blur-3xl" />

        {/* Geometric patterns */}
        <div className="absolute top-1/4 left-1/4 size-32 border border-[#2DCE73]/20 rounded-lg rotate-12" />
        <div className="absolute bottom-1/3 right-1/4 size-24 border border-[#013B34]/20 rounded-full" />
        <div className="absolute top-1/2 right-1/3 size-16 border border-[#2DCE73]/30 rotate-45" />
      </div>
